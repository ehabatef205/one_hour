...
class ViewDataOfHistoryWorkHelper extends StatefulWidget {
  final bool isArabic;
  final String user_id;
  final list;
  final data_history;

  const ViewDataOfHistoryWorkHelper({this.isArabic, this.user_id, this.list, this.data_history});

  @override
  _ViewDataOfHistoryWorkHelperState createState() => _ViewDataOfHistoryWorkHelperState();
}

class _ViewDataOfHistoryWorkHelperState extends State<ViewDataOfHistoryWorkHelper> {
  String needer_city = "";
