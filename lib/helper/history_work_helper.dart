...
import 'package:time_management/helper/view_data_of_history_work_helper.dart';
import 'dart:ui' as ui;
import 'home_page_helper.dart';

class HistoryWorkHelper extends StatefulWidget {
  final bool isArabic;
  final String user_id;

  const HistoryWorkHelper({this.isArabic, this.user_id});

  @override
  _HistoryWorkHelperState createState() => _HistoryWorkHelperState();
}

class _HistoryWorkHelperState extends State<HistoryWorkHelper> {
  List language;
                  ...
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return FutureBuilder(
                            future: getData(list2[index]["needer_id"]),
                            builder: (context, snapshot) {
                              if (snapshot.hasData) {
                                    ...
                                    ListTile(
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => ViewDataOfHistoryWorkHelper(
                                                  isArabic: widget.isArabic,
                                                  user_id: widget.user_id,
                                                  list: list,
