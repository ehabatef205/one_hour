...
class EditProfilePageHelper extends StatefulWidget {
  final bool isArabic;
  final list;

  EditProfilePageHelper({this.isArabic, this.list});

  @override
  _EditProfilePageHelperState createState() => _EditProfilePageHelperState();
}

class _EditProfilePageHelperState extends State<EditProfilePageHelper> {
  File _image;
  ...
  Future<File> change_file_name_only(File file, String new_file_name) async{
    ...
    var new_path = image_path.substring(0, last_separator + 1) + new_file_name + '.' + _image.path.split('.').last;
  ...
  Future uploadImage() async {
    final uri =
    Uri.parse("http://$local/test/upload_image_helper.php");
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    ...
                                    image: _image == null
                                        ? NetworkImage(
                                            "http://$local/test/uploads/helper/${widget.list['image']}")
                                        : FileImage(_image),
                                  ),
                                ),
                              ),
