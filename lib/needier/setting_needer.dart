...
import 'edit_password_needer.dart';
import 'package:http/http.dart' as http;
import 'dart:ui' as ui;

class SettingNeeder extends StatefulWidget {
  final String user_id;
  final bool isArabic;
  final String image;

  SettingNeeder({this.user_id, this.isArabic, this.image});

  @override
  _SettingNeederState createState() => _SettingNeederState();
}

class _SettingNeederState extends State<SettingNeeder> {
  bool state1 = true;
  bool state2 = true;
  bool state3 = true;
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => EditPasswordNeeder(
                                isArabic: widget.isArabic,
                                user_id: widget.user_id,
                                  )));
                    },
