...
class EditPasswordNeeder extends StatefulWidget {
  final String user_id;
  final bool isArabic;

  EditPasswordNeeder({this.user_id, this.isArabic});

  @override
  _EditPasswordNeederState createState() => _EditPasswordNeederState();
}

class _EditPasswordNeederState extends State<EditPasswordNeeder> {
