...
import 'forgetNeeder.dart';
import 'signup_needer.dart';
import 'home_page_needer.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:ui' as ui;

class LoginScreenNeeder extends StatefulWidget {
  final bool isArabic;

  const LoginScreenNeeder({this.isArabic});

  @override
  _LoginScreenNeederState createState() => _LoginScreenNeederState();
}

class _LoginScreenNeederState extends State<LoginScreenNeeder> {
          ...
          child: FlatButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => forgetNeeder()));
              },
      ...
      TextButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => SignUpNeeder(isArabic: widget.isArabic)));
        },
      ),
    ]);
  }
