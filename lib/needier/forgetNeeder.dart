...
import 'login_needer.dart';
import 'dart:ui' as ui;

class forgetNeeder extends StatefulWidget {
  @override
  _forgetNeederState createState() => _forgetNeederState();
}

class _forgetNeederState extends State<forgetNeeder> {
  ...
  Future checkUser() async {
    var response =
        await http.post(Uri.http("http://192.168.1.13/onehour/checkNeeder.php", ""), body: {
      "email": email.text,
    });
  ...
  Future resetPassword() async {
    ...
    Fluttertoast.showToast(
        ...
        fontSize: 16.0);
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => LoginScreenNeeder()));
  }
